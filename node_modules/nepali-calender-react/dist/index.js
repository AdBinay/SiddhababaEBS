...
var styles = {"calendarCcontain":"_1D41V","calendarDays":"_gHhFr","calendarTopbar":"_3dwv1","topbarDays":"_30eBi","saturday":"_13aKv","calendarWeek":"_jxd3s","calendarDay":"_2BApa","active":"_3sodH","holiday":"_1Kx67","calendarDate":"_1KwS1","inactive":"_3hvs3","taskCount":"_AiVxd","today":"_B6tPl","calendarTask":"_2Z61O","calendarTaskToday":"_3mOVN"};

var bsMonths = ['बैशाख', 'जेठ', 'आषाढ', 'श्रावण', 'भदौ', 'असोज', 'कार्तिक', 'मंसिर', 'पौष', 'माघ', 'फाल्गुन', 'चैत्र'];
var bsMonthsEnglish = ['Baisakh', 'Jesth', 'Aasad', 'Srawan', 'Bhadra', 'Aaswin', 'Kartik', 'Mangsir', 'Paush', 'Magh', 'Falgun', 'Chaitra'];
var bsDays = ['आईत', 'सोम', 'मंगल', 'बुध', 'बिही', 'शुक्र', 'शनि'];
var bsDaysFull = ['आइतवार', 'सोमवार', 'मंगलवार', 'बुधवार', 'बिहिवार', 'शुक्रवार', 'शनिवार'];
var adDaysFull = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
var adDays = ['Sun', 'Mon', 'Tues', 'Wed', 'Thu', 'Fri', 'Sat'];
...
var currentYear = function currentYear(year) {
  return dates[year];
};
...
var BikramSambatConverter = function BikramSambatConverter() {
  ...
  this.getNepaliMonth = function (m) {
    return this.nepaliMonths[m - 1];
  };

  this.getEnglishMonth = function (m) {
    return this.engMonths[m - 1];
  };

  this.getDayOfTheWeek = function (day) {
    return this.nepaliWeekdays[day - 1];
  };

  this.getEngDayOfTheWeek = function (day) {
    return this.engWeekDays[day - 1];
  };

  this.isRangeEng = function (yy, mm, dd) {
    if (yy < 1944 || yy > 2033) {
  ...
  this.toNepaliNumber = function (number) {
  ...
  this.engToNepali = function (yy, mm, dd) {
    yy = parseInt(yy);
    mm = parseInt(mm);
    dd = parseInt(dd);
    ...
    if (this.isRangeEng(yy, mm, dd) === false) {
      ...
      for (i = 0; i < yy - defEyy; i++) {
        if (this.isLeapYear(defEyy + i)) for (j = 0; j < 12; j++) {
          totalEdays += lmonth[j];
        } else for (j = 0; j < 12; j++) {
          totalEdays += month[j];
        }
      ...
      for (i = 0; i < mm - 1; i++) {
        if (this.isLeapYear(yy)) totalEdays += lmonth[i];else totalEdays += month[i];
      }
...
var date = new BikramSambatConverter();
var Calender = function Calender(_ref) {
  var language = _ref.language,
      mode = _ref.mode,
      onDateClicked = _ref.onDateClicked,
      startDate = _ref.startDate,
      dayClickBehaviour = _ref.dayClickBehaviour;
  var tempDate = new Date(startDate);
  var nepaliDate = date.engToNepali(tempDate.getFullYear(), tempDate.getMonth() + 1, tempDate.getDate());
  var activeDate = nepaliDate;

  var _useState = React.useState(nepaliDate.year),
      year = _useState[0],
      setYear = _useState[1];

  var _useState2 = React.useState(nepaliDate.nmonth),
      month = _useState2[0],
      setMonth = _useState2[1];

  var _useState3 = React.useState([]),
      clickedDates = _useState3[0],
      setClickedDates = _useState3[1];

  var yearInfo = currentYear(year);
  var currMonth = yearInfo[month - 1];
  var years = getYears();

  var handleDateClick = function handleDateClick(year, month, date, day) {
    if (dayClickBehaviour === 'multiple') {
      var tempClickedDates = [].concat(clickedDates);
      var index = tempClickedDates.findIndex(function (clickedDate) {
        return clickedDate.year === year && clickedDate.month === month && clickedDate.day === day && clickedDate.date === date;
      });
  ...
  return /*#__PURE__*/React__default.createElement("main", {
  ...
  }, mode === 'yearly' ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("select", {
    id: "year",
    value: year,
  ...
  }, language === 'nepali' ? bsMonths.map(function (month, i) {
    return /*#__PURE__*/React__default.createElement("option", {
      key: month,
      value: i + 1
    }, month);
  }) : bsMonthsEnglish.map(function (month, i) {
    return /*#__PURE__*/React__default.createElement("option", {
      key: month,
      value: i + 1
    }, month);
  ...
  }, language === 'nepali' ? bsDays.map(function (day, i) {
    return /*#__PURE__*/React__default.createElement("span", {
      key: i,
      className: styles.topbarDays + " " + (i + 1 === 7 && styles.saturday)
    }, day);
  }) : adDays.map(function (day, i) {
    return /*#__PURE__*/React__default.createElement("span", {
      key: i,
    ...
    return /*#__PURE__*/React__default.createElement("section", {
    ...
    }, num === 1 && Array.apply(null, {
      length: currMonth.weekStart
    }).map(function (e, i) {
      ...
      length: num === 1 ? 7 - currMonth.weekStart : num === Math.ceil((currMonth.weekStart + currMonth.endDate) / 7) ? 7 - (Math.ceil((currMonth.weekStart + currMonth.endDate) / 7) * 7 - currMonth.endDate - currMonth.weekStart) : 7
    }).map(function (e, i) {
      return /*#__PURE__*/React__default.createElement("div", {
        key: i,
        className: styles.calendarDay + " " + (clickedDates && clickedDates.every(function (date) {
          return date.date !== Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1);
        }) ? null : styles.active) + " " + (activeDate.date === Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1) && activeDate.nmonth === month && activeDate.year === year && styles.today) + " " + ((Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1) + currMonth.weekStart) % 7 === 0 && styles.holiday),
        onClick: function onClick() {
          return handleDateClick(year, month, Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1), (Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1) + currMonth.weekStart) % 7 === 0 ? 7 : (Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1) + currMonth.weekStart) % 7);
        }
      }, /*#__PURE__*/React__default.createElement("span", {
        className: styles.calendarDate
      }, language === 'nepali' ? date.toNepaliNumber(Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1)) : Math.max(0, 7 * (num - 1) - currMonth.weekStart) + (i + 1)));
    }), num === Math.ceil((currMonth.weekStart + currMonth.endDate) / 7) && Array.apply(null, {
      length: Math.ceil((currMonth.weekStart + currMonth.endDate) / 7) * 7 - currMonth.endDate - currMonth.weekStart
    }).map(function (e, i) {
      return /*#__PURE__*/React__default.createElement("div", {
        key: i,
        className: styles.calendarDay + " " + styles.inactive
...
Calender.defaultProps = {
  language: 'english',
  mode: 'monthly',
  onDateClicked: function onDateClicked() {},
...
var useNepaliNUmber = function useNepaliNUmber(number) {
  return date.toNepaliNumber(number);
};

exports.Calender = Calender;
exports.useNepaliNUmber = useNepaliNUmber;
